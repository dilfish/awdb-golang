...
const (
	// This is the value used in libawdb
...
func (d *decoder) unmarshalBool(size uint, offset uint, result reflect.Value) (uint, error) {
	if size > 1 {
		return 0, newInvalidDatabaseError("the aw DB file's data section contains bad data (bool size of %v)", size)
	}
...
func (d *decoder) unmarshalFloat32(size uint, offset uint, result reflect.Value) (uint, error) {
	if size != 4 {
		return 0, newInvalidDatabaseError("the aw DB file's data section contains bad data (float32 size of %v)", size)
	}
...
func (d *decoder) unmarshalFloat64(size uint, offset uint, result reflect.Value) (uint, error) {
	...
	if size != 8 {
		return 0, newInvalidDatabaseError("the aw DB file's data section contains bad data (float 64 size of %v)", size)
	}
...
func (d *decoder) unmarshalInt32(size uint, offset uint, result reflect.Value) (uint, error) {
	if size > 4 {
		return 0, newInvalidDatabaseError("the aw DB file's data section contains bad data (int32 size of %v)", size)
	}
...
func (d *decoder) unmarshalUint(size uint, offset uint, result reflect.Value, uintType uint) (uint, error) {
	if size > uintType/8 {
		return 0, newInvalidDatabaseError("the aw DB file's data section contains bad data (uint%v size of %v)", uintType, size)
	}
...
func (d *decoder) unmarshalUint128(size uint, offset uint, result reflect.Value) (uint, error) {
	if size > 16 {
		return 0, newInvalidDatabaseError("the aw DB file's data section contains bad data (uint128 size of %v)", size)
	}
